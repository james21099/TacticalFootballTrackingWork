...
def analyze_sequences(tracking_data, sequences_df, formations, keeper='1', home=True):
    ...
    The frame skip is 25 for speed, it is 10 for the project report.
    """
...
H_build_convex = main(H_tracking, H_build_up_sequences, sample_rate=10, team='Home', keeper_number=H_keeper_number, n_clusters=8, title = 'for Team A Build Ups')
H_possess_convex = main(H_tracking, H_possess_sequences, sample_rate=10, team='Home', keeper_number=H_keeper_number, n_clusters=8)
H_defend_convex = main(H_tracking, A_possess_sequences, sample_rate=10, team='Home', keeper_number=H_keeper_number, n_clusters=8)
H_press_convex = main(H_tracking, A_build_up_sequences, sample_rate=10, team='Home', keeper_number=H_keeper_number, n_clusters=8)
A_build_convex = main(A_tracking, A_build_up_sequences, sample_rate=10, team='Away', keeper_number=A_keeper_number, n_clusters=8)
A_possess_convex = main(A_tracking, A_possess_sequences, sample_rate=10, team='Away', keeper_number=A_keeper_number, n_clusters=8)
A_defend_convex = main(A_tracking, H_possess_sequences, sample_rate=10, team='Away', keeper_number=A_keeper_number, n_clusters=8)
A_press_convex = main(A_tracking, H_build_up_sequences, sample_rate=10, team='Away', keeper_number=A_keeper_number, n_clusters=8)



# Percentage best matched fomrations for home playing direction
flipped_formations = flip_formations(formations)
H_build_shape = analyze_sequences(H_tracking, H_build_up_sequences, flipped_formations, H_keeper_number, 'Home')
H_press_shape = analyze_sequences(H_tracking, A_build_up_sequences, flipped_formations, H_keeper_number, 'Home')
H_possess_shape = analyze_sequences(H_tracking, H_possess_sequences, flipped_formations, H_keeper_number, 'Home')
H_defend_shape = analyze_sequences(H_tracking, A_possess_sequences, flipped_formations, H_keeper_number, 'Home')
# Percentage best matched fomrations for away team
A_build_shape = analyze_sequences(A_tracking, A_build_up_sequences, formations, A_keeper_number, False)
A_press_shape = analyze_sequences(A_tracking, H_build_up_sequences, formations, A_keeper_number, False)
A_possess_shape = analyze_sequences(A_tracking, A_possess_sequences, formations, A_keeper_number, False)
A_defend_shape = analyze_sequences(A_tracking, H_possess_sequences, formations, A_keeper_number, False)


# The players with highest event counts for each team
A_top_players = top_players_for_events(A_events)
H_top_players = top_players_for_events(H_events)


# A measure of directness for possession and build-ups, using pass length
H_build_pass_length_directness = common_pass_dist(H_build_up_sequences, H_events)
A_build_pass_length_directness = common_pass_dist(A_build_up_sequences, A_events)
H_possess_pass_length_directness = common_pass_dist(H_possess_sequences, H_events)
A_possess_pass_length_directness = common_pass_dist(A_possess_sequences, A_events)


# A measure of directness for teams, using the length of phases in time[s] and passes
A_build_phase_length = avg_phase_length(A_build_up_sequences, A_events)
H_build_phase_length = avg_phase_length(H_build_up_sequences, H_events)
A_possess_phase_length = avg_phase_length(A_possess_sequences, A_events)
H_possess_phase_length = avg_phase_length(H_possess_sequences, H_events)
...
H_press_intensity = team_intensity(H_tracking, 'Home', A_build_up_sequences)
A_press_intensity = team_intensity(A_tracking, 'Away', H_build_up_sequences)
H_defend_intensity = team_intensity(H_tracking, 'Home', A_possess_sequences)
A_defend_intensity = team_intensity(A_tracking, 'Away', H_possess_sequences)
H_build_intensity = team_intensity(H_tracking, 'Home', H_build_up_sequences)
A_build_intensity = team_intensity(A_tracking, 'Away', A_build_up_sequences)
H_possess_intensity = team_intensity(H_tracking, 'Home', H_possess_sequences)
A_possess_intensity = team_intensity(A_tracking, 'Away', A_possess_sequences)


# Man pressing ratings for pressing and for defence
A_press_man_to_man = man_press_distance(H_tracking, A_tracking, H_build_up_sequences, 'Away')['result']
H_press_man_to_man = man_press_distance(H_tracking, A_tracking, A_build_up_sequences, 'Home')['result']
A_defend_man_to_man = man_press_distance(H_tracking, A_tracking, H_possess_sequences, 'Away')['result']
H_defend_man_to_man = man_press_distance(H_tracking, A_tracking, A_possess_sequences, 'Home')['result']
