...
import os
# Set your own correct working directory, folder containing all python files
os.chdir('/Users/jamesgothard/Research Project/Metrica/Python files/')
import pandas as pd
import csv as csv
import numpy as np
...
def to_single_playing_direction(home, away, events):
    for team in [home, away, events]:
        second_half_idx = team.loc[team['Period'] == 2].index.tolist()
