...
the average positions of the player throughout that phase.
"""
...
plot_best_match_formation(H_tracking, flipped_formations, 59421, H_keeper, home=True)
...
result_data = man_press_distance(H_tracking, A_tracking, A_build_ups, 'Home', frame_to_return=frame_number)
...
plot_avg_positions_all_sequences(A_build_ups, H_tracking, A_tracking, H_summary, A_summary, H_hull=H_press_convex, A_hull=None, team='home', filen = "H_press")
plot_avg_positions_all_sequences(A_build_ups, H_tracking, A_tracking, H_summary, A_summary, H_hull=None, A_hull=A_build_convex, team='away', filen = "A_build")
plot_avg_positions_all_sequences(H_build_ups, H_tracking, A_tracking, H_summary, A_summary, H_hull=H_build_convex, A_hull=None, team='home', filen = "H_build")
plot_avg_positions_all_sequences(H_build_ups, H_tracking, A_tracking, H_summary, A_summary, H_hull=None, A_hull=A_press_convex, team='away', filen = "A_press")
plot_avg_positions_all_sequences(A_possess, H_tracking, A_tracking, H_summary, A_summary, H_hull=H_defend_convex, A_hull=None, team='home', filen = "H_defend")
plot_avg_positions_all_sequences(A_possess, H_tracking, A_tracking, H_summary, A_summary, H_hull=None, A_hull=A_possess_convex, team='away', filen = "A_posses")
plot_avg_positions_all_sequences(H_possess, H_tracking, A_tracking, H_summary, A_summary, H_hull=H_possess_convex, A_hull=None, team='home', filen = "H_possess")
plot_avg_positions_all_sequences(H_possess, H_tracking, A_tracking, H_summary, A_summary, H_hull=None, A_hull=A_defend_convex, team='away', filen = "A_defend")
...
H_totals = calculate_totals(H_events, H_summary)
A_totals = calculate_totals(A_events, A_summary)
...
plot_all_passes(H_gk_passes, f"All home GK Passes (Game {game_id}, Team A)", 'home')
plot_all_passes(A_gk_passes, f"All away GK Passes (Game {game_id}, Team B)", 'away')
...
plot_passes_and_shots(H_passes_shots, H_shots, f"All home passes to shots (Game {game_id}, Team A)", 'home')
plot_passes_and_shots(A_passes_shots, A_shots, f"All away passes to shots (Game {game_id}, Team B)", 'away')
...
def create_highlight_reel(sequences_df, H_tracking, A_tracking, title="Title"):
    ...
    base_dir = '/Users/jamesgothard/fpath'
...
# create_highlight_reel(H_gk_pass, H_tracking, A_tracking, title="Home GK passes")
# create_highlight_reel(A_gk_pass, H_tracking, A_tracking, title="Away GK passes")
# create_highlight_reel(H_pre_shot_pass, H_tracking, A_tracking, title="Home passes before shots")
# create_highlight_reel(A_pre_shot_pass, H_tracking, A_tracking, title="Away passes before shots")
# create_highlight_reel(H_build_ups, H_tracking, A_tracking, title="Home build-ups")
# create_highlight_reel(A_build_ups, H_tracking, A_tracking, title="Away build-ups")
# create_highlight_reel(H_possess, H_tracking, A_tracking, title="Home possessions")
# create_highlight_reel(A_possess, H_tracking, A_tracking, title="Away possessions")
